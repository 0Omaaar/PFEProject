                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label>Titre</label>
                            <input type="text" name="titre" class="form-control nice-select-2" value="{{ $annonce->titre }}">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label>Prix</label>
                            <input type="number" name="prix" class="form-control nice-select-2" value="{{ $annonce->prix }}">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label>Kilometrage</label>
                            <input type="number" name="kilometrage" class="form-control nice-select-2" value="{{ $annonce->voiture->kilometrage }}">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select class="nice-select" name="marque_id" id="marque_id" onchange="filterModels()">
                                ...
                                <option value="{{ $marque->id }}" {{ $marque->id == $annonce->voiture->marque->id ? 'selected' : '' }}>
                                    {{ $marque->nom }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select class="nice-select" name="modele_id" id="modele_id">
                                ...
                                <option value="{{ $modele->id }}" data-marque="{{ $modele->marque_id }}" {{ $modele->id == $annonce->voiture->modele->id ? 'selected' : '' }}>
                                    {{ $modele->nom }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <img src="{{ asset('images/miniature/' . $annonce->miniature) }}" alt="{{ $annonce->titre }}" class="img-fluid mt-3 w-30 img-thumbnail mb-1" onclick="showImage('{{ asset('images/miniature/' . $annonce->miniature) }}')">
                    <div class="col-lg-12">
                        <div class="form-group">
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{ $option->id }}" name="options[]" id="option-{{ $option->id }}" @if (in_array($option->id, $selectedOptions)) checked @endif>
