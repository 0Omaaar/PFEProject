        ...
        <div class="form-group">
            <form action="{{ route('annonces.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <select id="puissance_fiscale" name="puissance_fiscale" style="width: 250px; margin-left: 10px">
                ...
                <div class="mt-2">
                    ...
                    <select id="marque_id" name="marque_id" style="width: 250px; margin-left: 10px"
