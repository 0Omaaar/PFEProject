...
<div class="container">
    ...
    <div class="form-group">
        <form action="{{ route('annonces.update', ['annonce' => $annonce->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <img src="{{ asset('images/miniature/' . $annonce->miniature) }}" alt="{{ $annonce->titre }}" class="img-fluid mt-3 w-25 img-thumbnail mb-1" onclick="showImage('{{ asset('images/miniature/' . $annonce->miniature) }}')">
            <div>
            ...
            <div>
                ...
                <input type="number" class="form-control" name="kilometrage" value="{{ $annonce->voiture->kilometrage }}">
            </div>
            <div>
            ...
            <img src="{{ asset('images/images/' . $image->chemin) }}" alt="{{ $annonce->titre }}" class="img-fluid w-25 img-thumbnail mt-2 mb-1" onclick="showImage('{{ asset('images/' . $image->chemin) }}')" />
            @endif
            @endforeach
            <div>
