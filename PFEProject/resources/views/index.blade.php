                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-6">
                        <div class="hero-content">
                            <h6 class="hero-sub-title" data-animation="fadeInUp" data-delay=".25s">Welcome To Motex!</h6>
...
<div class="row mx-auto text-center align-items-center mt-4">
    ...
    <div class="col-md-4">
        <a href="{{ route('annonces.parmarque', $marque->id) }}"><img src="{{ asset('images/logos/' . $marque->logo) }}" width="50px" alt="{{ $marque->nom }}" /></a>
    </div>
    @endforeach
</div>
